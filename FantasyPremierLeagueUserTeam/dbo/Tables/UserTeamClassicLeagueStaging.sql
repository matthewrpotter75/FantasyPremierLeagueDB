...
(
	...
	DateInserted SMALLDATETIME CONSTRAINT DF_UserTeamClassicLeagueStaging_DateInserted DEFAULT (GETDATE()) NOT NULL,
    CONSTRAINT PK_UserTeamClassicLeagueStaging PRIMARY KEY CLUSTERED (userteamid ASC, leagueid ASC, DateInserted ASC) ON FantasyPremierLeagueUserTeamStaging
