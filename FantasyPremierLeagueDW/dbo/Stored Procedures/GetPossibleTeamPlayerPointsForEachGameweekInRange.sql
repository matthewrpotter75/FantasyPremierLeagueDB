CREATE PROCEDURE dbo.GetPossibleTeamPlayerPointsForEachGameweekInRange
(
	@SeasonKey INT = NULL,
	@GameweekStart INT,
	@GameweekEnd INT,
...
BEGIN
	...
	(
		...
		ON pt.PlayerKey = bp.PlayerKey
		AND pt.SeasonKey = bp.SeasonKey
		AND pt.GameweekKey = bp.GameweekKey
	)
