...
BEGIN
	...
	PlayerHistoryRankedByGameweek AS
	(
		SELECT PlayerKey,
		SeasonKey,
		GameweekKey,
	...
	f.FractionOfMinutesPlayed,
	f.TotalGames,
	f.TeamTotalGames,
	f.DifficultyTotalGames,
	f.OverallPredictionPath,
	f.OverallPrediction,
	f.OverallPredictionWeighted,
	app.ActualPoints,
	app.ActualGames,
