	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				SELECT *
				FROM dbo.fnGetPlayersRankedAll(@UserTeamKey, @SeasonKey, @SpecifiedPlayerKey, @PlayerToRemoveKey, @PlayersToChangeKeys, @MaxNumberOfTransfers, @GameweekStart, @GameweekEnd, @TotalPointsRange, @PlayersToChangeCost, @Overspend, @PlayersToChangeTable);
		...
		BEGIN
			...
			BEGIN
				...
				SELECT *
				FROM dbo.fnGetPlayersRanked(@UserTeamKey, @SeasonKey, @SpecifiedPlayerKey, @PlayerToRemoveKey, @PlayersToChangeKeys, @MaxNumberOfTransfers, @GameweekStart, @GameweekEnd, @TotalPointsRange, @PlayersToChangeCost, @Overspend, @PlayersToChangeTable);
		...
		--MERGE INTO dbo.DimUserTeamPlayer AS Target 
		--USING 
		--(
		--	SELECT 
		--  @UserTeamKey AS UserTeamKey
		--	@SeasonKey AS SeasonKey,
		--	@GameweekStart AS GameweekStart,
		--	@GameweekEnd AS GameweekEnd,
		--	PlayerKey, 
		...
		--	FROM #CurrentSquad
		--)
		--AS Source (UserTeamKey, SeasonKey, GameweekStart, GameweekEnd, PlayerKey, PlayerPositionKey, Cost, TotalPoints, IsPlay)
		...
		--INSERT (UserTeamKey, SeasonKey, PlayerKey, Cost, IsPlay)
		--VALUES (Source.UserTeamKey, Source.SeasonKey, Source.PlayerKey, Source.Cost, Source.IsPlay)
