...
(
	...
	MinGameweekFixtureDatetime DATETIME NOT NULL CONSTRAINT [DF_PlayerPointsPerGamePrevious10_MinGameweekFixtureDatetime] DEFAULT 0,
	MaxGameweekFixtureDatetime DATETIME NOT NULL CONSTRAINT [DF_PlayerPointsPerGamePrevious10_MaxGameweekFixtureDatetime] DEFAULT 0,
